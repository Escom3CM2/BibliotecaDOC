...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	\begin{UseCase}{CU3.6}{Préstamo Interbibliotecario}{
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Pulsa el botón \IUbutton{Prestamo Interbibliotecario} del menú de acción del \UCref{CU3.2}
		...
		\UCpaso[\UCsist] Muestra la pantalla \IUref{IU3.6}{Formulario}.
		\UCpaso[\UCactor] Introduce los datos solicitados en los campos requeridos.
		\UCpaso[\UCactor] Pulsa el botón \IUbutton{Aceptar}.
		\UCpaso[\UCsist] Verifica la \BRref{RN3.13}{Llenado formulario de préstamo interbibliotecario}.[Trayectoria A]
		\UCpaso[\UCsist] Muestra la pantalla \IUref{IU3.6a}{Formato} con los datos del préstamo.
		\UCpaso[\UCactor] Pulsa el botón \IUbutton{Imprimir}
		\UCpaso[\UCsist] Se manda el formato a la cola de impresion
		\UCpaso[\UCsist] Muestra el \MSGref{MSJ3.16}{Se realizo correctamente}
...
%-------------------------------------- 
		\begin{UCtrayectoriaA}{B}{Él Lector tiene registrados 2 préstamos interbibliotecario}
			...
			\UCpaso[\UCactor] Presiona el botón \IUbutton{OK}
			\UCpaso[\UCsist] Redirecciona al Paso 10 del \UCref{CU3.2}.
		\end{UCtrayectoriaA}
%--------------------------------------
